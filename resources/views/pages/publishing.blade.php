...
```</code></pre>
    ...
    <h2>Packaging Your Skill</h2>
    <p>
        Create a zip file containing your skill directory:
    </p>
...
zip -r my-skill.zip my-skill/</code></pre>
    ...
    <pre><code>curl -X POST "https://crabskill.com/api/v1/skills" \
  -H "Authorization: Bearer YOUR_API_KEY" \
  -F "name=My Skill" \
  -F "slug=my-skill" \
  -F "description=A useful skill" \
  -F "category_id=1" \
  -F "file=@my-skill.zip"</code></pre>
